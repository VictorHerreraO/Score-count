...
class IncrementScoreUseCaseTest {
    ...
    @Test
    fun `execute increments player 1 score from 0-0 to 1-0`() =
        runTest {
            // Given
            val initialState =
                GameState(
    ...
    @Test
    fun `execute increments player 2 score from 0-0 to 0-1`() =
        runTest {
            // Given
            val initialState =
                GameState(
    ...
    @Test
    fun `execute completes set when reaching points to win`() =
        runTest {
    ...
    @Test
    fun `execute updates repository state`() =
        runTest {
            // Given
            val initialState =
                GameState(
