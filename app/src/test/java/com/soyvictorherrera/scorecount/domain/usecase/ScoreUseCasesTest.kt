...
class ScoreUseCasesTest {
    ...
    @Test
    fun `DecrementScoreUseCase decrements player 1 score from 5-3 to 4-3`() = runTest {
        // Given
    ...
    @Test
    fun `DecrementScoreUseCase decrements player 2 score from 3-7 to 3-6`() = runTest {
        // Given
        val useCase = DecrementScoreUseCase(fakeScoreRepository)
        val initialState = GameState(
    ...
    @Test
    fun `DecrementScoreUseCase does not go below 0`() = runTest {
        // Given
        val useCase = DecrementScoreUseCase(fakeScoreRepository)
        val initialState = GameState(
    ...
    @Test
    fun `DecrementScoreUseCase updates repository`() = runTest {
        // Given
        val useCase = DecrementScoreUseCase(fakeScoreRepository)
        val initialState = GameState(
    ...
    @Test
    fun `ManualSwitchServeUseCase switches serve from player 1 to player 2`() = runTest {
        // Given
    ...
    @Test
    fun `ManualSwitchServeUseCase switches serve from player 2 to player 1`() = runTest {
        // Given
        val useCase = ManualSwitchServeUseCase(fakeScoreRepository)
        val initialState = GameState(
    ...
    @Test
    fun `ManualSwitchServeUseCase updates repository`() = runTest {
        // Given
        val useCase = ManualSwitchServeUseCase(fakeScoreRepository)
        val initialState = GameState(
            player1 = Player(id = 1, name = "Alice", score = 0),
    ...
    @Test
    fun `ResetGameUseCase resets scores to 0-0`() = runTest {
        // Given
    ...
    @Test
    fun `ResetGameUseCase preserves player names`() = runTest {
        // Given
        val useCase = ResetGameUseCase(fakeScoreRepository, fakeSettingsRepository)
        val initialState = GameState(
    ...
    @Test
    fun `ResetGameUseCase with last winner serves first if winnerServesNextGame is true`() = runTest {
        // Given
    ...
    @Test
    fun `ResetGameUseCase with last winner does not serve if winnerServesNextGame is false`() = runTest {
        // Given
    ...
    @Test
    fun `ResetGameUseCase updates repository`() = runTest {
        // Given
        val useCase = ResetGameUseCase(fakeScoreRepository, fakeSettingsRepository)
        val initialState = GameState(
